...
type ServerCfg struct {
	...
	AutoPullEnable     bool         `mapstructure:"auto_pull_enable"`
	AutoPullRemoteHost string       `mapstructure:"auto_pull_remote_host"`
	BlockMode          bool         `mapstructure:"block_mode"`
...
func InitCfg() {
	...
	pflag.Bool("auto_pull_enable", false, "auto backsrc pull enabled")
	pflag.String("auto_pull_remote_host", "127.0.0.1:1935", "auto pull remote host")
	pflag.Bool("block_mode", false, "running in block mode")
	pflag.String("config_file", "grs.yaml", "configure filename")
	...
	// Print final config
	Config.Unmarshal(GlobalConfig)
	log.Debugf("Current configurations: \n%# v", pretty.Formatter(GlobalConfig))
}
