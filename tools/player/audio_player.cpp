...
AudioPlayer::AudioPlayer(AVCodecContext *codec_a_context, MediaDecoder* decoder):
...
void AudioPlayer::AudioCallback(void* userdata, Uint8* stream, int len) {
    ...
    AudioPlayer* md = (AudioPlayer*) userdata;
...
void AudioPlayer::InitAudioDevice() {
    ...
    want.silence = 0;
    want.callback = AudioPlayer::AudioCallback; /* callback function */
    want.userdata = this;

    cout << "sample rate: " << this->m_codec_a_context->sample_rate << endl;
    cout << "channels: " << this->m_codec_a_context->channels << endl;
    cout << "samples: " << this->m_codec_a_context->frame_size << endl;
    cout << "sample fmt: " << this->m_codec_a_context->sample_fmt << endl;
...
AVFrame* AudioPlayer::PopAudioFrame() {
