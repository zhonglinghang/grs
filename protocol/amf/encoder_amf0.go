...
func (e *Encoder) EncodeAmf0StringValue(w io.Writer, str string) (int, error) {
	if len(str) <= AMF0_STRING_MAX {
		return e.EncodeAmf0String(w, str, true)
	}
	return e.EncodeAmf0LongString(w, str, true)
...
func (e *Encoder) EncodeAmf0IntValue(w io.Writer, val int64) (int, error) {
	return e.EncodeAmf0Number(w, float64(val), true)
}

func (e *Encoder) EncodeAmf0ObjectValue(w io.Writer, val Object) (int, error) {
	if val == nil {
		return e.EncodeAmf0Null(w, true)
	}
	return e.EncodeAmf0Object(w, val, true)
}
